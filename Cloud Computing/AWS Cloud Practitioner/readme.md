...
Practical Static Website Hosting:
```
S3 > Buckets> <Bucket_name> > Properties > Static Website Hosting, Edit and Enable, Specify the Index document. Save Changes.
Upload the index file into the bucket.
