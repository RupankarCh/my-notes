...
Jinja 2: A service to create dynamic template 
Definition: Jinta 2 is a template language used by ansible to create dynamic files.
...
ansible -i inventory webserver -m ansible.builtin.ping

cd templates/
vim welcome.j2
Welcome to Ansible Jinja2 Template.
This file was generated by Ansible.
vim play1.yml
```
---
- name: Basic Jinja2 Template
  hosts: webserver
  become: true

  tasks: 
    - name: Deploy Welcome Template
      ansible.builtin.template:
        src: /home/ansible/ansible-jinja/template/welcome.j2
        dest: /tmp/welcome.txt
        mode: '0644'
```
ansible-playbook -i /home/ansible/ansible-jinja/inventory play1.yml --syntax-check (Check syntax)

ansible-playbook -i /home/ansible/ansible-jinja/inventory play1.yml

ansible webserver -i /home/ansible/ansible-jinja/inventory -m command -a "ls -l /tmp/welcome.txt"
...
- name: Deploy Jinja2 Template
  ...
  tasks: 
    ...
    - name: Generate Server Information File
      ansible.builtin.template: 
        src: /home/ansible/ansible-jinja/templates/systeminfo.j2
        dest: /tmp/system-info.txt
        mode: '0644'
```
ansible-playbook -i /home/ansible/ansible-jinja/inventory systeminfo.yml --syntax-check   

ansible-playbook -i /home/ansible/ansible-jinja/inventory systeminfo.yml

ansible webserver -i /home/ansible/ansible-jinja/inventory -m command -a "ls -l /tmp/systeminfo.txt"
...
```
---
- name: Install FTP only on RHEL-9
  hosts: all
  become: true
